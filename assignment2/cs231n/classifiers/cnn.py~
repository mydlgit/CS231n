...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        pass
        C,H,W=input_dim
        self.params['W1']=np.random.randn(num_filters,C,filter_size,filter_size)*weight_scale #卷积核
    ...
    def loss(self, X, y=None):
        ...
        conv_param = {'stride': 1, 'pad': (filter_size - 1) // 2} #这样选择pad是为了保证经过卷积层后，尺寸不变
        ...
        grad_term1,grads['W3'],grads['b3']=affine_backward(ds,self.cache['cache3'])
        grads['W3']+=self.reg*self.params['W3']

        grad_term2,grads['W2'],grads['b2']=affine_relu_backward(grad_term1,self.cache['cache2'])
        grads['W2']+=self.reg*self.params['W2']  

        dx,grads['W1'],grads['b1'],grads['gamma'],grads['beta']=conv_bn_relu_pool_backward(grad_term2,self.cache['cache1'])
